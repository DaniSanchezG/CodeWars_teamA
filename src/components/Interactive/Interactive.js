  ...
  return (
    <div className={classes.container}>
      ...
      <ul className={classes.lateral}>
          ...
          <img className={classes.img2} src={require("../../assets/2.webp")} />
          <h3 className={classes["text-2"]}>Star Wars Jedi: Survivor: Cameron Monaghan on Cal Kestis' Next Adventure</h3>
          </div>
         <img className={classes.trapecio} src={require("../../assets/trapecio.jpg")}  />
       
        <div className={classes["wrapper-img2"]}>
          <img className={classes.img2} src={require("../../assets/3.webp")} />
          <h3 className={classes["text-2"]}>Cal Kestis Returns in Star Wars Jedi: Battle Scars - Cover Reveal</h3>
          </div>
          {/* <div className={classes.trapecio}></div> */}
        
        <div className={classes["wrapper-img2"]}>
          <img className={classes.img2} src={require("../../assets/4.webp")} />
          <h3 className={classes["text-2"]}>Quiz: Which Star Wars Video Game Should You Play Right Now?</h3>
          </div>
          {/* <div className={classes.trapecio}></div> */}
